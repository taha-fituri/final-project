      ...
      <div className="home-partimer">
        <div className="divs">
          <div>
            <h2 style={{ textAlign: "left", fontSize: "xxx-large" }}>
              {pargaph}About the city of Tajoura
            </h2>{" "}
        ...
        <div className="countdiv">
          <div className="counterbuttons">
            ...
            />
            <h2>Do you want to measure your reading speed???</h2>
            <h3>
              Here is the challenge Start the counter and read the pargraph to
              know how many seconds it took to read it
            </h3>
            <Timer />{" "}
          </div>
        </div>
